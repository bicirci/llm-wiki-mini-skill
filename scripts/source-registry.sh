...
用法：
  ...
  bash scripts/source-registry.sh list-by-category <core_builtin|manual_only|optional_adapter>
...
match_url() {
  local url="$1"
  local host source_id source_label source_category input_mode match_rule raw_dir adapter_name dependency_name dependency_type fallback_hint
  local fallback_row=""
